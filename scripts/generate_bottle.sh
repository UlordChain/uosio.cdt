...
mkdir -p ${PROJECT}/${VERSION}/opt/uosio_cdt/lib/cmake
...
echo "class UosioCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/uosio/uosio.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/uosio/uosio.cdt/releases/download/v${VERSION}\"
