...
// Definitions in `uosio.cdt/libraries/uosio/time.hpp`
UOSIO_TEST_BEGIN(microseconds_type_test)
silence_output(true);
...
// Definitions in `uosio.cdt/libraries/uosio/time.hpp`
UOSIO_TEST_BEGIN(time_point_type_test)
   silence_output(true);
...
// Definitions in `uosio.cdt/libraries/uosio/time.hpp`
UOSIO_TEST_BEGIN(time_point_sec_type_test)
   silence_output(true);
...
// Definitions in `uosio.cdt/libraries/uosio/time.hpp`
UOSIO_TEST_BEGIN(block_timestamp_type_test)
   silence_output(true);
...
int main(int argc, char* argv[]) {
   UOSIO_TEST(microseconds_type_test);
   UOSIO_TEST(time_point_type_test);
   UOSIO_TEST(time_point_sec_type_test);
   UOSIO_TEST(block_timestamp_type_test);
   return has_failed();
}
