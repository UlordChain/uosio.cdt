...
struct D1 : public B {
   const int i{};
   UOSLIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   UOSLIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `uosio.cdt/libraries/uosio/serialize.hpp`
UOSIO_TEST_BEGIN(serialize_test)
   silence_output(true);
