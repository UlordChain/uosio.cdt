...
#include <uosio/varint.hpp>

using std::numeric_limits;

using uosio::datastream;
using uosio::unsigned_int;
using uosio::signed_int;
...
// Defined in `uosio.cdt/libraries/uosio/varint.hpp`
UOSIO_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `uosio.cdt/libraries/uosio/varint.hpp`
UOSIO_TEST_BEGIN(signed_int_type_test)
   silence_output(false);
...
int main(int argc, char* argv[]) {
   UOSIO_TEST(unsigned_int_type_test)
   UOSIO_TEST(signed_int_type_test);
   return has_failed();
}
