...
#include <uosio/asset.hpp>

using std::string;

using uosio::name;
using uosio::symbol;
using uosio::extended_symbol;
using uosio::asset;
using uosio::extended_asset;
...
// Definitions in `uosio.cdt/libraries/uosio/asset.hpp`
UOSIO_TEST_BEGIN(asset_type_test)
   silence_output(true);
...
// Definitions in `uosio.cdt/libraries/uosio/asset.hpp`
UOSIO_TEST_BEGIN(extended_asset_type_test)
   silence_output(true);

   static constexpr symbol sym_no_prec{"SYMBOLL",0};
   static constexpr symbol sym_prec{"SYMBOLL",63};

   static constexpr extended_symbol ext_sym_no_prec{sym_no_prec, name{"uosioaccountj"}};
   static constexpr extended_symbol ext_sym_prec{sym_prec, name{"uosioaccountj"}};
   ...
   CHECK_EQUAL( (extended_asset{{},ext_sym_no_prec}.contract), (name{"uosioaccountj"}) )

   //// extended_asset(asset, name)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"uosioaccountj"}}.quantity), (asset{ 0LL, sym_no_prec}) )
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"uosioaccountj"}}.contract), (name{"uosioaccountj"}) )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         extended_asset{asset_no_prec, name{"uosioaccountj"}} + extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}};
      })
   )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         temp += extended_asset{asset_no_prec, name{"uosioaccountj"}};
      })
   )
   ...
   // --------------------------------------------------------------------
   // friend bool operator!=(const extended_asset&, const extended_asset&)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"uosioaccountj"}} != extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{-1LL, sym_no_prec}, {}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{ 0LL, sym_no_prec}, name{"uosioaccountj"}}), true )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         bool b{extended_asset{{}, name{}} < extended_asset{{}, name{"uosioaccountj"}}};
         return b;
      })
   )
...
int main(int argc, char* argv[]) {
   UOSIO_TEST(asset_type_test);
   UOSIO_TEST(extended_asset_type_test);
   return has_failed();
}
