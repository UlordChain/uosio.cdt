...
// Definitions in `uosio.cdt/libraries/uosio/name.hpp`
UOSIO_TEST_BEGIN(name_type_test)
   silence_output(true);
   ...
   CHECK_EQUAL( name{"uos"}.length(), 3 )
   CHECK_EQUAL( name{"uosi"}.length(), 4 )
   CHECK_EQUAL( name{"uosio"}.length(), 5 )
   CHECK_EQUAL( name{"uosioa"}.length(), 6 )
   CHECK_EQUAL( name{"uosioac"}.length(), 7 )
   CHECK_EQUAL( name{"uosioacc"}.length(), 8 )
   CHECK_EQUAL( name{"uosioacco"}.length(), 9 )
   CHECK_EQUAL( name{"uosioaccou"}.length(), 10 )
   CHECK_EQUAL( name{"uosioaccoun"}.length(), 11 )
   CHECK_EQUAL( name{"uosioaccount"}.length(), 12 )
   CHECK_EQUAL( name{"uosioaccountj"}.length(), 13 )

   CHECK_ASSERT( "string is too long to be a valid name", ([]() {name{"12345abcdefghj"}.length();}) )
   
   // ----------------------------
   // constexpr name suffix()const
   CHECK_EQUAL( name{".uosioaccounj"}.suffix(), name{"uosioaccounj"} )
   CHECK_EQUAL( name{"e.osioaccounj"}.suffix(), name{"osioaccounj"} )
   CHECK_EQUAL( name{"eo.sioaccounj"}.suffix(), name{"sioaccounj"} )
   CHECK_EQUAL( name{"uos.ioaccounj"}.suffix(), name{"ioaccounj"} )
   CHECK_EQUAL( name{"uosi.oaccounj"}.suffix(), name{"oaccounj"} )
   CHECK_EQUAL( name{"uosio.accounj"}.suffix(), name{"accounj"} )
   CHECK_EQUAL( name{"uosioa.ccounj"}.suffix(), name{"ccounj"} )
   CHECK_EQUAL( name{"uosioac.counj"}.suffix(), name{"counj"} )
   CHECK_EQUAL( name{"uosioacc.ounj"}.suffix(), name{"ounj"} )
   CHECK_EQUAL( name{"uosioacco.unj"}.suffix(), name{"unj"} )
   CHECK_EQUAL( name{"uosioaccou.nj"}.suffix(), name{"nj"} )
   CHECK_EQUAL( name{"uosioaccoun.j"}.suffix(), name{"j"} )

   CHECK_EQUAL( name{"e.o.s.i.o.a.c"}.suffix(), name{"c"} )
   CHECK_EQUAL( name{"uos.ioa.cco"}.suffix(), name{"cco"} )
