...
public:
  ...
  bool isUosioTable() const { return hasAttr<UosioTableAttr>(); }
  bool isUosioIgnore() const { return hasAttr<UosioIgnoreAttr>(); }
  ...
  UosioTableAttr*  getUosioTableAttr() const { return getAttr<UosioTableAttr>(); }
