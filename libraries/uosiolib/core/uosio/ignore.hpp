...
namespace uosio {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::uosio::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::uosio::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::uosio::ignore<T>&) {
     return ds;
   }
}
