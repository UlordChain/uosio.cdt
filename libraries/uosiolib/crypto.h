...
#warning "<uosiolib/crypto.h> is deprecated use <uosio/crypto.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
 ...
 *  uosio::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  uosio::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((uosio_wasm_import))
 ...
 *  uosio::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((uosio_wasm_import))
 ...
 *  uosio::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((uosio_wasm_import))
 ...
 *  uos_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((uosio_wasm_import))
 ...
 *  uosio::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((uosio_wasm_import))
