...
#warning "<uosiolib/symbol.hpp> is deprecated use <uosio/symbol.hpp>"
namespace uosio {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const uosio::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, uosio::symbol_code& sym_code) {
         uint64_t raw = 0;
