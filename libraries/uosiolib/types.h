...
#warning "<uosiolib/types.h> is deprecated use <uosio/types.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
...
/**
 * UOSIO Public Key. It is 34 bytes.
 */
...
/**
 * UOSIO Signature. It is 66 bytes.
 */
