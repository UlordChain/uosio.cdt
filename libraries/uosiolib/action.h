...
#warning "<uosiolib/action.h> is deprecated use <uosio/action.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
...
extern "C" {
    ...
    *
    *
    * A UOS.IO action has the following abstract structure:
    *
    * ```
    *   struct action {
