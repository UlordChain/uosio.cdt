 ...
 * @ingroup contracts
 * @ingroup types
 * @brief Defines contract type which is %base class for every UOSIO contract
 */
...
/**
 * %Base class for UOSIO contract.
 *
 * @ingroup contract
 * @details %Base class for UOSIO contract. %A new contract should derive from this class, so it can make use of UOSIO_ABI macro.
 */
class contract {
   public:
      /**
