### Usage
---
To manually compile the source code, use `uosio-cpp/uosio-cc` and `uosio-ld` as if it were __clang__ and __lld__. All the includes and options specific to UOSIO and CDT are baked in.

###$ uosio-cpp
---
```
USAGE: uosio-cpp [options] <input file> ...
