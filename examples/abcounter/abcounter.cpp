...
class [[uosio::contract]] abcounter : public uosio::contract {
  public:
  ...
  private:
    ...
    using count_index = uosio::multi_index<"counts"_n, counter>;
};

UOSIO_DISPATCH( abcounter, (count));
