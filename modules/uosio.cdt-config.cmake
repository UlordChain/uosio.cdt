if(UOSIO_CDT_ROOT STREQUAL "" OR NOT UOSIO_CDT_ROOT)
   set(UOSIO_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${UOSIO_CDT_ROOT}/lib/cmake/uosio.cdt)
if (NOT UOSIO_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(UOSIO_WASM_OLD_BEHAVIOR "On")
    include(UosioWasmToolchain)
endif()

include(UosioCDTMacros)
...
function(UOSIO_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(UOSIO_CHECK_VERSION)
